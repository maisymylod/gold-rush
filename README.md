...
A Python library for managing goldsmith candidates and client relationships in the jewelry industry recruitment space.

## Features

- **Candidate Management**: Track goldsmith candidates with their skills, experience, specializations, and availability
- **Client Management**: Manage clients seeking goldsmith services with their specific requirements
- **Smart Matching**: Automatically match candidates with client requirements using a sophisticated scoring algorithm
...
candidate = Candidate(
    ...
    phone="555-0100",
    skills=["soldering", "stone setting", "engraving"],
...
experienced_candidates = candidate_db.search_by_experience(min_years=5.0)
...
client = Client(
    ...
    required_skills=["stone setting", "repair", "resizing"],
    preferred_specializations=["antique restoration"],
